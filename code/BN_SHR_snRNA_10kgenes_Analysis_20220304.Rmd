---
title: "snRNA-Seq Analysis Using BNLx/SHR - 10,000 genes Analysis"
...
```{r, apply_filters}
bcells <- subset(bcells, subset = nFeature_RNA > 250 & nFeature_RNA < 10000)
...
```{r select_dims}
bcells <- FindNeighbors(bcells, dims = 1:50)
bcells <- FindClusters(bcells, resolution = 0.25)
...
```{r saveRDS}
# save Seurat Object
saveRDS(bcells, file = paste0(data_dir, "/", "bcells_15kgenes.rds"))
```
...
write_csv(bcells.markers, file = paste0(data_dir, "/", "all_markers_all_clusters_15kgenes.csv"))
```
